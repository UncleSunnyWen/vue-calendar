...
<template>
    <div class="calendar_body" ref="calendarBody">
        ...
        <div @touchend="touchEnd" @touchmove.stop.prevent="touchMove" @touchstart="touchStart" class="bar" ref="bar">
            <span @click="today" class="today" v-if="showTodayButton">今</span>
